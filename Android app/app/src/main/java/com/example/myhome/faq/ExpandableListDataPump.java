...
public class ExpandableListDataPump {
    public static HashMap<String, List<String>> getData() {
        ...
        faq1.add("The term smart home refers to the regular home, which has its appliances, lighting, and electronic devices connected to the internet to enable remote monitoring and management. The homeowner enjoys the convenience of securing, operating, and monitoring their house even from another side of the world. The devices that are connected are lights and electricity");
        ...
        faq4.add("There are a variety of devices and appliances that get connected and controlled in a smart home setup. The most common ones fall into four categories, and they are lighting, climate control and electricity");
        ...
        faq8.add("Our smart home application is specifically designed to empower disabled individuals and others by providing an intuitive and accessible way to control various aspects of their home environment. the application enables users to effortlessly manage their living spaces according to their unique needs.");
        ...
        expandableListDetail.put("How can the smart home application assist disabled individuals and others in controlling their home more easily?", faq8);
