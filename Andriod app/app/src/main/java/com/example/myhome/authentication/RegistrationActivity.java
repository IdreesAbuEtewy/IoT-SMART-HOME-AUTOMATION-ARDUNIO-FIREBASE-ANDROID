...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void sendUserData(String name, String emailid, String phone, String password){
        ...
        componentsdb.put("port1", "0");
        componentsdb.put("port2", "0");
        componentsdb.put("port3", "0");
        componentsdb.put("port4", "0");
        componentsdb.put("port5", "0");
        componentsdb.put("port6", "0");
        ...
        users.child(firebaseUser.getUid()).child("AutomaticOnOff").child("port5").setValue(aof);
        users.child(firebaseUser.getUid()).child("AutomaticOnOff").child("port6").setValue(aof);
