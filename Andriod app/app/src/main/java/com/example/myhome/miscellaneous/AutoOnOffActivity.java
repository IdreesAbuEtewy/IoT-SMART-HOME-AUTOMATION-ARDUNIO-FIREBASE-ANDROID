...
public class AutoOnOffActivity extends AppCompatActivity {
    private WeekdaysPicker pw1, pw2, pw3, pw4, pw5, pw6;
    private TextView startTimeP1, startTimeP2, startTimeP3, startTimeP4, startTimeP5, startTimeP6;
    private TextView stopTimeP1, stopTimeP2, stopTimeP3, stopTimeP4, stopTimeP5, stopTimeP6;
    private Button finalButton1, finalButton2, finalButton3, finalButton4, finalButton5, finalButton6;
    private ArrayList<Integer> pa1, pa2, pa3, pa4, pa5, pa6;
    private String selectedDays1, selectedDays2, selectedDays3, selectedDays4, selectedDays5, selectedDays6;
    private TimePickerDialog startPicker1, startPicker2, startPicker3, startPicker4, startPicker5, startPicker6,
            stopPicker1, stopPicker2, stopPicker3, stopPicker4, stopPicker5, stopPicker6;
    private String sd1, sontime1, sofftime1, sd2, sontime2, sofftime2,
            sd3, sontime3, sofftime3, sd4, sontime4, sofftime4,
            sd5, sontime5, sofftime5, sd6, sontime6, sofftime6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pw5 = findViewById(R.id.weekdaysp5);
        pw6 = findViewById(R.id.weekdaysp6);
        ...
        startTimeP5 = findViewById(R.id.startTime5);
        startTimeP6 = findViewById(R.id.startTime6);
        ...
        stopTimeP5 = findViewById(R.id.stopTime5);
        stopTimeP6 = findViewById(R.id.stopTime6);
        ...
        finalButton5 = findViewById(R.id.buttonUp5);
        finalButton6 = findViewById(R.id.buttonUp6);
        ...
        startTimeP5.setText(utilTime(hour) + ":" + utilTime(minutes));
        startTimeP6.setText(utilTime(hour) + ":" + utilTime(minutes));
        ...
        stopTimeP5.setText(utilTime(hour) + ":" + utilTime(minutes));
        stopTimeP6.setText(utilTime(hour) + ":" + utilTime(minutes));
        ...
        startTimeP5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                startPicker5 = new TimePickerDialog(AutoOnOffActivity.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker tp, int sHour, int sMinute) {
                                startTimeP5.setText(utilTime(sHour) + ":" + utilTime(sMinute));
                            }
                        }, hour, minutes, true);
                startPicker5.show();
            }
        ...
        startTimeP6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                startPicker6 = new TimePickerDialog(AutoOnOffActivity.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker tp, int sHour, int sMinute) {
                                startTimeP6.setText(utilTime(sHour) + ":" + utilTime(sMinute));
                            }
                        }, hour, minutes, true);
                startPicker6.show();
            }
        ...
        stopTimeP5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                stopPicker5 = new TimePickerDialog(AutoOnOffActivity.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker tp, int sHour, int sMinute) {
                                stopTimeP5.setText(utilTime(sHour) + ":" + utilTime(sMinute));
                            }
                        }, hour, minutes, true);
                stopPicker5.show();
            }
        ...
        stopTimeP6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                stopPicker6 = new TimePickerDialog(AutoOnOffActivity.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker tp, int sHour, int sMinute) {
                                stopTimeP6.setText(utilTime(sHour) + ":" + utilTime(sMinute));
                            }
                        }, hour, minutes, true);
                stopPicker6.show();
            }
        ...
        selectedDays5 = pw5.getSelectedDaysText().toString();
        selectedDays6 = pw6.getSelectedDaysText().toString();
        ...
        pw5.setOnWeekdaysChangeListener(new OnWeekdaysChangeListener() {
            @Override
            public void onChange(View view, int clickedDayOfWeek, List<Integer> selectedDays) {
                selectedDays5 = pw5.getSelectedDaysText().toString();
            }
        ...
        pw6.setOnWeekdaysChangeListener(new OnWeekdaysChangeListener() {
            @Override
            public void onChange(View view, int clickedDayOfWeek, List<Integer> selectedDays) {
                selectedDays6 = pw6.getSelectedDaysText().toString();
            }
    ...
    protected void onStart() {
        ...
        database.child("AutomaticOnOff").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    sd5 = (String) dataSnapshot.child("port5").child("days").getValue();
                    sontime5 = (String) dataSnapshot.child("port5").child("ontime").getValue();
                    sofftime5 = (String) dataSnapshot.child("port5").child("offtime").getValue();

                    sd6 = (String) dataSnapshot.child("port6").child("days").getValue();
                    sontime6 = (String) dataSnapshot.child("port6").child("ontime").getValue();
                    sofftime6 = (String) dataSnapshot.child("port6").child("offtime").getValue();
                    ...
                    pa5 = new ArrayList<Integer>();
                    if (sd5.contains("Sunday")) {
                        pa5.add(1);
                    }
                    if (sd5.contains("Monday")) {
                        pa5.add(2);
                    }
                    if (sd5.contains("Tuesday")) {
                        pa5.add(3);
                    }
                    if (sd5.contains("Wednesday")) {
                        pa5.add(4);
                    }
                    if (sd5.contains("Thursday")) {
                        pa5.add(5);
                    }
                    if (sd5.contains("Friday")) {
                        pa5.add(6);
                    }
                    if (sd5.contains("Saturday")) {
                        pa5.add(7);
                    }

                    pw5.setSelectedDays(pa5);
                    startTimeP5.setText(sontime5);
                    stopTimeP5.setText(sofftime5);

                    pa6 = new ArrayList<Integer>();
                    if (sd6.contains("Sunday")) {
                        pa6.add(1);
                    }
                    if (sd6.contains("Monday")) {
                        pa6.add(2);
                    }
                    if (sd6.contains("Tuesday")) {
                        pa6.add(3);
                    }
                    if (sd6.contains("Wednesday")) {
                        pa6.add(4);
                    }
                    if (sd6.contains("Thursday")) {
                        pa6.add(5);
                    }
                    if (sd6.contains("Friday")) {
                        pa6.add(6);
                    }
                    if (sd6.contains("Saturday")) {
                        pa6.add(7);
                    }

                    pw6.setSelectedDays(pa6);
                    startTimeP6.setText(sontime6);
                    stopTimeP6.setText(sofftime6);
        ...
        finalButton5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.start();

                database.child("AutomaticOnOff/port5").addValueEventListener(new ValueEventListener() {
                    @RequiresApi(api = Build.VERSION_CODES.N)
                    @Override
                    public void onDataChange(final DataSnapshot dataSnapshot) {

                        if(dataSnapshot.exists()) {
                            HashMap<String,String> mapBt5=new HashMap<String,String>();

                            if (selectedDays5 != null) {
                                mapBt5.put("days",selectedDays5);
                            } else {
                                mapBt5.put("days","NA");
                            }
                            mapBt5.put("ontime",startTimeP5.getText().toString());
                            mapBt5.put("offtime",stopTimeP5.getText().toString());

                            dataSnapshot.getRef().setValue(mapBt5).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    DynamicToast.makeSuccess(AutoOnOffActivity.this, "Updated Successfully!", 10).show();
                                }
        ...
        finalButton6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.start();

                database.child("AutomaticOnOff/port6").addValueEventListener(new ValueEventListener() {
                    @RequiresApi(api = Build.VERSION_CODES.N)
                    @Override
                    public void onDataChange(final DataSnapshot dataSnapshot) {

                        if(dataSnapshot.exists()) {
                            HashMap<String,String> mapBt6=new HashMap<String,String>();

                            if (selectedDays6 != null) {
                                mapBt6.put("days",selectedDays6);
                            } else {
                                mapBt6.put("days","NA");
                            }
                            mapBt6.put("ontime",startTimeP6.getText().toString());
                            mapBt6.put("offtime",stopTimeP6.getText().toString());

                            dataSnapshot.getRef().setValue(mapBt6).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    DynamicToast.makeSuccess(AutoOnOffActivity.this, "Updated Successfully!", 10).show();
                                }
